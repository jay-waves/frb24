...
到开发者确认修复，其中有8个重要漏洞被美国通用漏洞披露（CVE）收录，7个通过中国国
...
methods, such as traffic analysis, to infer internal states. The approach led to the discovery of 28 ROS2 software vulnerabilities, with 11 confirmed and
fixed by developers, including 8 recognized by the US's CVE and 7 awaiting final
